...
# SPECIFICATION: This file contains the main function for operating the document operations
# in a MongoDB collection, utilizing functions imported from the db_connection_mongo.py file
